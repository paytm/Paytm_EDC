...
public class MainActivity extends BaseActivity {
    ...
    private void initComponent() {
        ...
        Button mOpenConnectionBtn = findViewById(R.id.btn_open);
        Button mCloseConnectionBtn = findViewById(R.id.btn_close);
        ...
        mOpenConnectionBtn.setOnClickListener(onClickListener);
        mCloseConnectionBtn.setOnClickListener(onClickListener);
    }
    ...
    private final View.OnClickListener onClickListener = view -> {
        if (R.id.btn_open == view.getId()) {
        ...
        } else if (R.id.btn_init == view.getId()) {
            ...
            SampleApp.getInstance().getPayments().openBluetoothSettings();
